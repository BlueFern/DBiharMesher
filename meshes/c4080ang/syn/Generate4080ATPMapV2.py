...
GenerateATPMapV2.atpMin = 0.2
GenerateATPMapV2.atpMax = 0.4 # This is actually the ATP range.
GenerateATPMapV2.outMin = -1.2
GenerateATPMapV2.outMax = 0.8
