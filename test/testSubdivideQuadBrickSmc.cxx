...
int main(int argc, char* argv[]) {
	...
	vtkSmartPointer<vtkSubdivideQuadBrickSmc> subdivideQuadFilter = vtkSmartPointer<vtkSubdivideQuadBrickSmc>::New();
