 ...
 * Parent branch
 * For full bifurcation 'testWrapDbihar12' and 'testWrapDbihar13' are needed
 */
...
int main(int argc, char* argv[]) {
	...
	double derivB	= 0.8*L;				//Set magnitude of derivatives along fist half of bifurcation
	double derivC	= 0.8*L;				//Set magnitude of derivatives along second half of bifurcation
