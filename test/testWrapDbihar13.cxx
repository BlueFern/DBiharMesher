 ...
 * Second daughter branch
 * For full bifurcation 'testWrapDbihar12' and 'testWrapDbihar14' are needed
 */
...
int main(int argc, char* argv[]) {
	...
	double depth1	= 1485.01;	// 1485.01				//Depth in Z direction
	double depth2	= 1100;	// 1430.45				//Depth in -Z direction
	double derivC	= 0.25*L;				//Set magnitude of derivatives along fist half of bifurcation
	double derivB	= 0.8*L;				//Set magnitude of derivatives along second half of bifurcation
	...
	double alpha	= ((360-angleBif)/4)*deg2rad;
	double beta		= (angleBif/2)*deg2rad;
