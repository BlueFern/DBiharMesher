...
int main(int argc, char* argv[]) {
	...
	vtkDbiharStatic::WritePolyData(dbiharPatchSmooth->GetOutput(), "quadMeshFullSmoothc8064.vtp");
	...
	vtkDbiharStatic::WritePolyData(subdivideECMesh->GetOutput(), "quadMeshFullSmoothECc8064.vtp");
	...
	vtkDbiharStatic::WritePolyData(subdivideSMCMesh->GetOutput(), "quadMeshFullSmoothSMCc8064.vtp");
	...
	for (int i = 0; i < endPointIds->GetNumberOfIds(); i++)
	{
		...
		vtkDbiharStatic::WriteStlData(triangleCapFilter->GetOutput(), (SSTR("triCap_" << i << "Smooth_c8064.stl")).c_str());
	}
	...
	vtkDbiharStatic::WriteStlData(triangleFullMeshFilter->GetOutput(), "triMeshFullSmoothc8064.stl");
