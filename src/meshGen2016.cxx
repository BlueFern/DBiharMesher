...
int main(int argc, char* argv[]) {
	...
	vtkDbiharStatic::WritePolyData(scalarRadiiToVectorsFilter->GetOutput(), "c2016_RadiiToVectors.vtp");
	...
	// vtkDbiharStatic::WritePolyData(centrelinePartitioner->GetOutput(), "c2016_part.vtp");
	...
	vtkDbiharStatic::WritePolyData(fullMeshJoiner->GetOutput(), "quadMeshFullc2016.vtp");
	...
	vtkDbiharStatic::WritePolyData(subdivideECMesh->GetOutput(), "quadMeshFullECc2016.vtp");
	...
	vtkDbiharStatic::WritePolyData(subdivideSMCMesh->GetOutput(), "quadMeshFullSMCc2016.vtp");
	...
	for (int i = 0; i < endPointIds->GetNumberOfIds(); i++)
	{
		...
		vtkDbiharStatic::WriteStlData(triangleCapFilter->GetOutput(), (SSTR("triCap_" << i << "_c2016.stl")).c_str());
	}
	...
	vtkDbiharStatic::WriteStlData(triangleFullMeshFilter->GetOutput(), "triMeshFullc2016.stl");
