...
int main(int argc, char* argv[]) {
	...
	// vesselCentrelineReader->SetFileName((prefix + "c216Centreline.vtk").c_str());
	vesselCentrelineReader->SetFileName("c216Centreline.vtk");
	...
	// vtkDbiharStatic::WritePolyData(centrelinePartitioner->GetOutput(), "c216CentrelinePartitioned.vtp");
	...
	// vtkDbiharStatic::WritePolyData(subdivideECMesh->GetOutput(), (prefix + "quadMeshFullECc216.vtp").c_str());
	...
	// vtkDbiharStatic::WritePolyData(subdivideSMCMesh->GetOutput(), (prefix + "quadMeshFullSMCc216.vtp").c_str());
	...
	for (int i = 0; i < endPointIds->GetNumberOfIds(); i++)
	{
		...
		// vtkDbiharStatic::WriteStlData(triangleCapFilter->GetOutput(), (prefix + SSTR("triCap_" << i << "_c216.stl")).c_str());
		vtkDbiharStatic::WriteStlData(triangleCapFilter->GetOutput(), (SSTR("triCap_" << i << "_c216.stl")).c_str());
	}
	...
	// vtkDbiharStatic::WriteStlData(triangleFullMeshFilter->GetOutput(), (prefix + "triMeshFullc216.stl").c_str());
	vtkDbiharStatic::WriteStlData(triangleFullMeshFilter->GetOutput(), "triMeshFullc216.stl");
#endif
