...
int main(int argc, char* argv[]) {
	...
	vtkDbiharStatic::WritePolyData(scalarRadiiToVectorsFilter->GetOutput(), "c1008_RadiiToVectors.vtp");
	...
	// vtkDbiharStatic::WritePolyData(centrelinePartitioner->GetOutput(), "c1008_part.vtp");
	...
	vtkDbiharStatic::WritePolyData(fullMeshJoiner->GetOutput(), "quadMeshFullc1008.vtp");
	...
	vtkDbiharStatic::WritePolyData(subdivideECMesh->GetOutput(), "quadMeshFullECc1008.vtp");
	...
	vtkDbiharStatic::WritePolyData(subdivideSMCMesh->GetOutput(), "quadMeshFullSMCc1008.vtp");
	...
	for (int i = 0; i < endPointIds->GetNumberOfIds(); i++)
	{
		...
		vtkDbiharStatic::WriteStlData(triangleCapFilter->GetOutput(), (SSTR("triCap_" << i << "_c1008.stl")).c_str());
	}
	...
	vtkDbiharStatic::WriteStlData(triangleFullMeshFilter->GetOutput(), "triMeshFullc1008.stl");
