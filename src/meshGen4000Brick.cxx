...
int main(int argc, char* argv[]) {
	...
	subdivideMeshBrick->SetInputData(fullMeshJoiner->GetOutput());
	subdivideMeshBrick->SetRows(numECs);
	subdivideMeshBrick->SetColumns((vtkDbiharStatic::SMC_CIRC / vtkDbiharStatic::EC_CIRC) * numSMCs);
	subdivideMeshBrick->SetAxialQuads(100);
	subdivideMeshBrick->SetCircQuads(numRadialQuads * 2);
	subdivideMeshBrick->SetFlat(false);
	subdivideMeshBrick->SetBranches(1);
	subdivideMeshBrick->SetCellType(vtkDbiharStatic::EC);
	...
	vtkDbiharStatic::WritePolyData(subdivideMeshBrick->GetOutput(), "quadMeshFullECc4000.vtp");

	subdivideMeshBrick->SetInputData(fullMeshJoiner->GetOutput());
	subdivideMeshBrick->SetColumns(numSMCs);
	subdivideMeshBrick->SetRows((vtkDbiharStatic::EC_AXIAL / vtkDbiharStatic::SMC_AXIAL) * numECs);
	subdivideMeshBrick->SetAxialQuads(100);
	subdivideMeshBrick->SetCircQuads(numRadialQuads * 2);
	subdivideMeshBrick->SetFlat(false);
	subdivideMeshBrick->SetBranches(1);
	...
	vtkDbiharStatic::WritePolyData(subdivideMeshBrick->GetOutput(), "quadMeshFullSMCc4000.vtp");
